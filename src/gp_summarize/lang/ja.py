...
prompts = [
    ...
    ("# 概要", "日本語で、一行の文章で要約せよ。"),
    ("## 問題意識", "論文はどのような問題を解決しようとしているか？日本語で理解の助けになるのであれば数式も含めて回答せよ。"),
    ("## 手法", "論文はどのような手法を提案しているか？日本語で理解の助けになるのであれば数式も含めて回答せよ。"),
    ("## 新規性", "論文はどのような新規性があるか？日本語で理解の助けになるのであれば数式も含めて回答せよ。"),
...
sprompt = ("セクション「%s」を日本語で理解の助けになるのであれば数式も含めて要約せよ。", "」「")
